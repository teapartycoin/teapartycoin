...
static const int64 MAX_MONEY = 17730000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 120 / 250; // 120 blocks found a day. Priority cutoff is 1 TPC day / 250 bytes.
    }
